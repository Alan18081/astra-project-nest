...
(function (CommunicationCodes) {
    ...
    CommunicationCodes["GET_USER"] = "[UsersService] Get UserEntity";
    CommunicationCodes["GET_USER_BY_GOOGLE_ID"] = "[UsersService] Get UserEntity By Google Id";
    CommunicationCodes["GET_USER_BY_ID"] = "[UsersService] Get UserEntity By ID";
    CommunicationCodes["GET_USER_BY_EMAIL"] = "[UsersService] Get UserEntity By Email";
    CommunicationCodes["CREATE_USER"] = "[UsersService] Create UserEntity";
    CommunicationCodes["CREATE_USER_BY_GOOGLE"] = "[UsersService] Get UserEntity By Google";
    CommunicationCodes["UPDATE_USER"] = "[UsersService] Update UserEntity";
    CommunicationCodes["REMOVE_USER"] = "[UsersService] Remove UserEntity";
    CommunicationCodes["RESET_USER_PASSWORD"] = "[UsersService] Reset UserEntity Password";
    CommunicationCodes["LOGIN"] = "[AuthService] Login UserEntity";
    CommunicationCodes["LOGIN_BY_GOOGLE"] = "[AuthService] Login UserEntity By Google";
    ...
    CommunicationCodes["GET_PROJECTS_LIST_BY_USER"] = "[ProjectsService] Get Projects By UserEntity";
    ...
    CommunicationCodes["GET_USER_HASH_BY_HASH"] = "[UsersService] Get UserEntity Hash By Hash";
    ...
    CommunicationCodes["CHANGE_USER_PASSWORD"] = "[UsersService] Change UserEntity Password";
...
//# sourceMappingURL=communication-codes.enum.js.map